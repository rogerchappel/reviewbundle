...
Replace this section with the supported versions for `reviewbundle`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `reviewbundle` explicitly provides them.
